...
import { initGraph, SET_USER, SET_MODE, SET_REVISION, SET_DATA, SET_EXERCISES, SET_LAYOUT, SET_ERROR } from '../action/actionUserGraph';
...
const mode = ( state = initGraph.mode, action ) => action.type === SET_MODE ? action.payload : state;
